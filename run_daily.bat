...
echo [1/6] Updating daily prices...
...
echo [2/6] Updating market indices...
...
echo [3/6] Updating news risks (DART disclosures, last 30 days)...
...
echo [6/6] Starting web server and opening browser...
